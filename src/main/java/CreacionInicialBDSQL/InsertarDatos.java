...
public class InsertarDatos {
    ...
    public static void MenuInsercion(Connection connection) {
        int opcion;
        do {
            opcion = menu();
            switch (opcion) {
    ...
    public static void InsertarCentro(Connection Connection) {
    ...
    public static void InsertarProyecto(Connection Connection) {
        try (Connection connection = Connection) {
            int id_Proyecto;
            String titulo;
            String descripcion;
    ...
    public static void InsertarUsuario(Connection Connection) {
        try (Connection connection = Connection) {
            ...
            if (insertar) {
                ...
                ps = connection.prepareStatement("INSERT INTO Usuario(ID_Centro,ID_USUARIO,Nombre,Apellidos,Contraseña,Rol,Puntuacion,Familia_Profesional,Email,Telefono) VALUES (?,?,?,?,?,?,?,?,?,?)");
