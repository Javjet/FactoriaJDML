...
public class ModificarDatos {
    ...
    //Metodo para modificar datos del centro con controles de datos
    private static void ModificarCentro(Connection Connection) {
    ...
    private static void ModificarProyecto(Connection Connection) {
        try (Connection connection = Connection) {
    ...
    private static void ModificarUsuario(Connection Connection) {
        try (Connection connection = Connection) {
