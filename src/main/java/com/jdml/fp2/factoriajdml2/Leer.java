...
public class Leer {
    ...
    /**
     * @param texto - Referencia al contenido del dato solicitado
     * @param regex - expresión regular a aplicar. Si es null se aplica un entero generico
     * @return dato - Entero tecleado
     */
    ...
    /**
     * @param texto - Referencia al contenido del dato solicitado
     * @param regex - expresión regular a aplicar. Si es null se aplica un double gen�rico
     * @return dato - Double tecleado
     */
    ...
    /**
     * @param texto - Referencia al contenido del dato solicitado
     * @param regex - expresión regular a aplicar. Si es null se aplica un float gen�rico
     * @return dato - Float tecleado
     */
